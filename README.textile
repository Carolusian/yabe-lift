...
There is a comet feature demonstration at comment page. Just open a&nbsp;

article at http://yabe.ayafish.com in two browsers at the same time.&nbsp;

Then add a comment to the article in one of the browsers. You will see&nbsp;

that comment appears in another browser in real-time without refresh.
